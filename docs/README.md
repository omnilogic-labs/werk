...
| **[open-questions.md](open-questions.md)**                                       | The thirty questions these documents raise and none of them answers. The only register of them: the options for each, and any lean labelled as a lean.                                |
