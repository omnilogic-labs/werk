...
| ------------------------------------------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [00-stack-proof-of-concept.md](00-stack-proof-of-concept.md) | A throwaway detachable process runner, built to find out whether TypeScript on Bun with libghostty-vt via upstream's WebAssembly build survives contact |
