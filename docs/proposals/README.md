...
| [02-session-library.md](02-session-library.md)               | Three private workspace packages for terminal state, the portable session client/contracts and the Bun host, with their API direction and implementation sequence.                                                                                                                                                                                                                         |
